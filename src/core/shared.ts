...
import { b64url, deriveE2EKey, encryptBlob, fromB64url } from "./crypto";
 ...
 *  shared E2E key from the stored qrSecret + the returned phoneNonce, uses the device-name decrypt as
 *  a tamper gate, rewrites config.json to its COMPLETED form (qrSecret dropped, e2eKeyB64 present,
